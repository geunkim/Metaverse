...
![중앙 집중형 메타버스](Image/20230719_Metaverse_1.png)

현재 대부분의 메타버스는 중앙 집중형 서비스를 제공한다. 메타버스 서비스 제공자는 사용자들에게 메타버스 이용을 위한 클라이언트를 제공하며 사용자는 이를 통해 메타버스 서비스 제공자가 만든 메타버스 서버에 접속하여 서비스를 이용한다. 사용자는 메타버스 서버 접속에 사용자 인증을 거치며 사용자의 개인 정보를 제공한다. 

위와 같은 중앙 집중형 메타버스는 다음과 같은 장점을 지닌다.

- 중앙 집중형 메타버스의 장점 
  - 클라이언트의 가벼움 : 메타버스의 크기 및 다양성이 클수록 이를 관리하기 위한 비용이 발생하나 중앙 집중형 메타버스는 이를 서버 측에서 관리하여 사용자의 관리 비용을 줄인다.
...
- 중앙 집중형 메타버스의 단점
  ...
  - 사용자 정보 해킹 : 하나의 서버가 많은 사용자의 정보를 관리할 경우 해킹을 통해 큰 피해가 발생할 수 있으며 사용자는 이를 제어할 수 없다.
  - 

#### 탈중앙 Metaverse

![탈중앙메타버스](Image/20230719_Metaverse_1_2.png)
