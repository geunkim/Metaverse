...
## Soulbound Token
### 양도 불가능한 NFT
Soulbound는 월드 오브 워크래프트라는 게임에서 파생된 용어로, 한 번 획득하면 다른 플레이어에게 양도하거나 판매할 수 없는 특성을 의미   
즉, 한 번 획득을 통해 본인의 속성을 하나 추가하게 되는 것
예시로는 현실에서 국적, 주민등록등본, 학력, 이력 등 거래해서는 안되는 개인정보  

### 장점
- 블록체인에서 전송할 수 없는 NFT를 말하며, 개인의 디지털 아이덴티티의 기본 요소를 형성한다는 아이디어에서 탄생했다는 것
-  “Web3 내의 신용” 문제점을 해결하고 새로운 생태계인 탈중앙화 사회(DeSoc)를 이루기 위한 시작이라고 할 수 있다.
### 단점
- SBT는 전송할 수 없고 공개적으로 볼 수 있는 블록체인 기반 토큰이며, 이러한 토큰은 교육 증명서, 출생 증명서 및 국가 신원과 같은 자격 증명을 나타낼 수 있어서 많은 사람들은  주류의 SBT 채택이 사생활을 침해할 수 있다며 우려를 표함

### SBT와 NFT의 차이점
|              | SBT                           | NFT                            |
|--------------|-------------------------------|--------------------------------|
| 정의         | 게임 내에서 특정 아이템에 연결된 토큰 | 고유하고 대체 불가능한 디지털 자산 |
| 대표적인 플랫폼 | Enjin, 소울바운드 게임                  | Ethereum, Flow, Binance Smart Chain |
| 유형         | 게임 아이템에 대한 소유권 토큰         | 고유한 디지털 콘텐츠의 소유권 토큰   |
| 교환성        | 일부 SBT는 교환 가능                 | NFT는 대체 불가능                  |
| 소유권 확인   | 블록체인을 통해 소유권 확인          | 블록체인을 통해 소유권 확인          |
| 다양한 사용처 | 게임 내에서 아이템 거래, 플레이어 경제 | 예술 작품, 가상 부동산, 가상 게임 등 |
| 특별한 속성   | 아이템의 희귀성, 속성, 업그레이드 등   | 고유한 디자인, 특정 속성 및 기능    |
