...
##### 스왑(Swap)
두 개의 암호화폐를 교환하는 과정을 말합니다. 스왑은 일반적으로 사용자가 가지고 있는 한 종류의 암호화폐를 다른 종류의 암호화폐로 교환하고자 할 때 사용됩니다. 이를 통해 사용자는 자신이 보유한 암호화폐를 다른 암호화폐로 전환할 수 있습니다.

##### 스테이킹(Staking)
일반적으로 Proof of Stake (PoS) 블록체인에서 사용되는 개념입니다. 스테이킹은 보유한 암호화폐를 해당 블록체인 네트워크에 예치하여 보상을 받는 과정입니다. 이를 통해 스테이커는 네트워크의 보안과 운영에 기여하고, 보상을 받을 수 있습니다. 스테이킹은 네트워크의 분산과 보안을 강화하며, 보상을 통해 참여자들에게 경제적 이익을 제공합니다.
#
## 지갑의 차이
|지갑 이름|주요 특징|
|----|-----------------------------|
